        ...
        function(r) {
            ...
            smartExtension[0].extension.forEach(function(arg, index, array) {
                if (arg.url === "authorize") {
                    authorize_uri = "https://open-ic.epic.com/Argonaut/oauth2/authorize";
                }
                else if (arg.url === "token") {
                    token_uri = "https://open-ic.epic.com/Argonaut/oauth2/token";
                }
            });
...
function getDceasedBoolean(){
    ...
    return $.ajax({
        ...
        function(pt) {
            return pt.deceasedBoolean.toString();
        },
        function() {
            return "Could not fetch " + url;
        }
...
function getCareProvider() {
    ...
    return $.ajax({
        ...
        function(pt) {
            return pt.careProvider[0].display;
        },
        function() {
            return "Could not fetch " + url;
        }
